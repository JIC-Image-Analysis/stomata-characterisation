...
def get_fpaths(directory, channel_index, series_index):
    """Yield the file paths for a particular channel and series."""
    fpaths = []
    for fname in os.listdir(directory):
        ...
        series = name.split('_')[-4]
        if channel == 'C{}'.format(channel_index) and series == 'S{}'.format(series_index):
